...
public class Controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		// Standard StationBoard ist aktuell Zurich Oerlikon Post mit ID 8503006
		stationBoard = transportAPI.getStationBoard("8503006");
		
		//Alle Listen nicht anklickbar machen
		...
		bt_search.setOnAction(ae -> {
			...
			try {
				...
				// Wenn beide Textfelder ausgefüllt sind, dann werden Verbindungen zwischen den beiden Orten angezeigt
				// Ansonsten ein StationBoard des Ortes aus dem ersten Textfeld
		...
		lv_weather.setCellFactory(param -> new ListCell<String>() {
			...
			public void updateItem(String name, boolean empty) {
				...
				if (empty) {
					...
					//in name stehen der Bildcode für das Icon und die Temperatur daher splitten
